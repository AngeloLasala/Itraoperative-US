...
def infer(par_dir, trial, split, experiment, epoch, guide_w, scheduler, 
          medsam_path,
...
if __name__ == '__main__':
    ...
    infer(par_dir = os.path.join(args.save_folder, args.type_image),  trial=args.trial, split= args.split, experiment=args.experiment,
          epoch=args.epoch, guide_w=args.guide_w, scheduler=args.scheduler,
