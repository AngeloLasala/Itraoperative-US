"""
Perceputal loss based on LPIPS. Taken from the original paper at # Taken from https://github.com/richzhang/PerceptualSimilarity/blob/master/lpips/lpips.py
"""
...
class LPIPS(nn.Module):
    def __init__(self, net='vgg', version='0.1', use_dropout=True):
        ...
        import os
        model_path = os.path.abspath(
                    os.path.join(os.path.dirname(os.path.abspath(__file__)), 'weights', 'v%s' % version, '%s.pth' % net))
