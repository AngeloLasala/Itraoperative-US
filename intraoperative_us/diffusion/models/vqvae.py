"""
Vector Quantized Variational Autoencoder (VQVAE) model for latent diffuzion models
"""
import torch
...
if __name__ == '__main__':
    ...
    model = VQVAE(im_channels=1, model_config=autoencoder_config) 
    out, z, loss= model(x)
    print(out.shape, z.shape, loss)