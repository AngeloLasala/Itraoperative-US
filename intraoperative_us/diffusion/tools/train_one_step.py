"""
Train Unconditional latent diffusion model with hugginface.
One tep generation -> unconditional diffusion model to simultaneusly 
generate the Intraoperative US images and the tumor mask
"""
import torch
import yaml
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--type_image', type=str, default='one_step', help='type of image, ius or one_step')
