...
#SBATCH --error=sample_sd_fine_4.err       # standard error file
#SBATCH --output=sample_sd_fine_4.out      # standard output file
    ...
    for w in -1.0; do
        for epoch in 3000 6000 9000 ; do
                python -m intraoperative_us.diffusion.tools.sample_stable_diffusion\
                        ...
                        --trial $trial\
                        --experiment SD_init_sd1.5_cond_empty_text_16\
                        --epoch $epoch\
                        --guide_w $w\
