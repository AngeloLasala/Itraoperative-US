...
def infer(par_dir, conf, trial, experiment, epoch, guide_w, compute_real, compute_gen):
    ...
    logging.info(f'len train data {len(data)}')
    ...
    data_gen = IntraoperativeUS(size= [dataset_config['im_size_h'], dataset_config['im_size_w']],
                               dataset_path= dataset_config['dataset_path'],
                               im_channels= dataset_config['im_channels'],
                               splitting_json=dataset_config['splitting_json'], 
                               split='train',
    ...
    loggig.info(f'len gen data {len(data_gen)}')
